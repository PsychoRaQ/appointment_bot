...
from src.dialogs.admin_dialogs.edit_calendary.getters import get_free_times_from_date, slot_info_for_user
# хэндлеры
from src.dialogs.admin_dialogs.edit_calendary.handlers import (admin_choose_time_slot_for_edit, admin_close_slot,
