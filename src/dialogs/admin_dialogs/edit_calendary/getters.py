...
from src.services.database_func import get_slots_list_from_db, user_is_register, get_slot_from_db
# сервисные функции
from src.services.service_func import datetime_format, create_time_slots
# datetime
