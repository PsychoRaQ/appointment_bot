...
# импорт состояний
from src.fsm.admin_states import AllAppointments
# импорт сервисных функций-билдеров
from src.services.widget_builder_for_dialogs import get_weekday_button, get_group
# геттеры
from src.dialogs.user_dialogs.make_new_appointment.getters import get_free_dates
from src.dialogs.admin_dialogs.view_all_appointments.getters import get_all_slots
# хэндлеры
from src.dialogs.admin_dialogs.view_all_appointments.handlers import admin_choose_view_date
