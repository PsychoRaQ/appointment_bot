...
# состояния
from src.fsm.user_states import UserNewAppointmentSG
# билдеры для инлайн клавиатур
from src.services.widget_builder_for_dialogs import get_weekday_button, get_group
# геттеры
from src.dialogs.user_dialogs.make_new_appointment.getters import (get_free_dates, get_free_times_from_date,
                                                                   get_confirm_datetime)
# хэндлеры
from src.dialogs.user_dialogs.make_new_appointment.handlers import (choose_time_for_appointment,
