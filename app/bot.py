...
from app.dialogs import admin_dialogs as admin_dg, user_dialogs as user_dg
# конфигурация бота
from config.config import load_config, load_database, load_nats
# хэндлеры для команд
from app.handlers import user_handlers, unregister_handlers, admin_handlers
# мидлвари
from app.middlewares.session import DbSessionMiddleware
from app.middlewares.user_role import UserRoleMiddlware
# функция для внесения всех пользователей из базы в кэш
from app.utils.database_func import get_all_users_from_db
# меню бота
from app.utils.service_func import set_main_menu
# натс
from app.services.nats_service.utils.nats_connect import connect_to_nats
from app.services.nats_service.utils.start_consumers import (start_delayed_consumer, start_dispatch_consumer,
