...
# геттеры
from app.dialogs.admin_dialogs.main_menu.getters import get_admin_menu, get_admin_role, get_admin_feedback
# хэндлеры
from app.dialogs.admin_dialogs.main_menu.handlers import admin_dialog_selection
