...
# геттеры
from app.dialogs.admin_dialogs.view_all_admins.getters import get_all_admins, get_admin_data
# хэндлеры
from app.dialogs.admin_dialogs.view_all_admins.handlers import correct_id, edit_admin_data, edit_sub_days
