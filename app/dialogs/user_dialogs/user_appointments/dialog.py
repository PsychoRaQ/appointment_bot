...
# состояния
from app.fsm.user_states import (UserAppointmentSG)
# геттеры
from app.dialogs.user_dialogs.user_appointments.getters import get_user_appointments
# хэндлеры
from app.dialogs.user_dialogs.user_appointments.handlers import (user_is_confirmed_delete_appointment,
