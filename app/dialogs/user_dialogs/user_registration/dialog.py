...
# геттеры
from app.dialogs.user_dialogs.user_registration.getters import get_userdata
# хэндлеры
from app.dialogs.user_dialogs.user_registration.handlers import (confirm_registration, correct_input, check_phone,
