...
# консьюмер
from app.services.nats_service.consumers.delayed_message_consumer import DelayedMessageConsumer
from app.services.nats_service.consumers.dispatch_consumer import DispatchConsumer
from app.services.nats_service.consumers.subscribe_consumer import SubscribeConsumer
# натс
